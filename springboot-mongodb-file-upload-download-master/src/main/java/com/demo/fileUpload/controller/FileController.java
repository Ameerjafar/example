...
public class FileController {
    ...
    @PostMapping("/upload")
    public ResponseEntity<?> upload(@RequestParam("file") MultipartFile file, @RequestParam("deptsemsub") String str) throws IOException {
        return new ResponseEntity<>(fileService.addFile(file, str), HttpStatus.OK);
    }
